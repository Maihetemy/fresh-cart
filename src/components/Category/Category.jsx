  ...
  return (
    <>
      {categoryProductList.length > 0 ? (
        <>
          <h3 className="mt-3 mb-7 font-bold text-green-950 text-2xl">{categoryProductList[0].category.name}</h3>
          <div className="row">
        ...
        <h2 className="text-center my-20 font-bold text-green-950 text-2xl">No Products</h2>
      )}
    </>
  );
